...
export class routes {
  ...
  public static get teleUser(): string {
    return this.baseUrl + 'telephony/tele-user';
  }
  public static get campaigns(): string {
    return this.baseUrl + 'telephony/campaigns';
  }
  public static get filter(): string {
    return this.baseUrl + 'telephony/filter';
  }
  public static get inbound(): string {
    return this.baseUrl + 'telephony/inbound';
  }
  public static get teleList(): string {
    return this.baseUrl + 'telephony/tele-list';
  }
  public static get teleScript(): string {
    return this.baseUrl + 'telephony/tele-script';
  }
  public static get teleFile(): string {
    return this.baseUrl + 'telephony/voice-file';
  }
  public static get roleRight(): string {
    return this.baseUrl + 'adminstrator/role-right';
  }
  public static get adminiModule(): string {
    return this.baseUrl + 'adminstrator/adminstrator-module';
  }
  public static get webRTC(): string {
    return this.baseUrl + 'adminstrator/adminstrator-webRTC';
  }
  public static get adminiSetting(): string {
    return this.baseUrl + 'adminstrator/adminstrator-setting';
  }
  public static get agentsList(): string {
    return this.baseUrl + 'agent/agent-list';
  }
  public static get extensionGroupList(): string {
    return this.baseUrl + 'agent/agent-extension';
  }
  public static get customWebPage(): string {
    return this.baseUrl + 'custom/custom-webpage';
  }
  public static get clientContact(): string {
    return this.baseUrl + 'custom/custom-clientContact';
  }
  public static get clientContacts(): string {
    return this.baseUrl + 'contact/Contact';
  }
}
