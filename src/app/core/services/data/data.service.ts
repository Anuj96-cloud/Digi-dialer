...
export class DataService {
  ...
  private assets = new BehaviorSubject<any[]>([
    {
      assetUser: 'Richard_Miles@gmail.com',
      assetName: 'Dell Laptop',
      assetId: '#AST-0001',
      assetStatus: 'Pending',
      userGroup: 'AGENTS',
      warrenty: 'Active',
      warrentyEnd: '05-01-2023',
      Amount: '$1215',
      id: 1,
    },
    // ... Add other assets here based on your provided JSON
  ]);
  ...
  updateAsset(updatedAsset: any) {
    const currentAssets = this.assets.value;
    const index = currentAssets.findIndex(asset => asset.assetId === updatedAsset.assetId);
    if (index !== -1) {
      currentAssets[index] = updatedAsset; // Update the asset
      this.assets.next([...currentAssets]); // Emit new value
    }
  }
  ...
  deleteAsset(assetId: string) {
    const currentAssets = this.assets.value;
    const updatedAssets = currentAssets.filter(asset => asset.assetId !== assetId);
    this.assets.next(updatedAssets); // Emit new value
  }
  ...
  },
  {
...

    {
     ...
     menu: [
  {
    menuValue: 'Role & Rights',
    route: routes.roleRight,
    hasSubRoute: false,
    showSubRoute: false,
    icon: 'user-shield',   
    materialicons: 'person',   
  ...
  },
  {
    ...
    {
      tittle: 'Remote Agents',
      icon: 'layers',
      showAsTab: false,
      separateRoute: false,
     menu: [
  {
    menuValue: 'Agents List',
    route: routes.agentsList,
    hasSubRoute: false,
    showSubRoute: false,
    icon: 'user-shield',   
    materialicons: 'person',   
  ...
  {
    menuValue: 'Extension Group List',
    route: routes.extensionGroupList,
    hasSubRoute: false,
    showSubRoute: false,
    icon: 'clone',  
    materialicons: 'clone',   
    subMenus: [],
        ...
        menu: [
        {
        menuValue: 'Custom Web Page',
        route: routes.customWebPage,
        hasSubRoute: false,
        showSubRoute: false,
        icon: 'user-shield',   
        materialicons: 'person',   
        ...
        {
        menuValue: 'Client Contact Module',
        route: routes.clientContact,
        hasSubRoute: false,
        showSubRoute: false,
        icon: 'clone',  
        materialicons: 'clone',   
