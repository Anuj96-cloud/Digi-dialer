  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'telephony',
        loadChildren: () =>
          import('../feature-module/telephony/telephonly/telephony.module').then(
            (m) => m.TelephonyModule
          ),
      },
      {
        path: 'adminstrator',
        loadChildren: () =>
          import('../feature-module/adminstrator/adminstrator/adminstrator.module').then(
      ...
      },
      {
        path: 'agent',
        loadChildren: () =>
          import('../feature-module/agents/agent/agent.module').then(
            (m) => m.AgentModule
          ),
      },
      {
